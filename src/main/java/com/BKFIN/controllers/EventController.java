...
public class EventController {
	...
	EventService eventService;
		...
		public void assignagev(@PathVariable("idEvent") Long eventid ,@PathVariable("idAgent")Long agentid) throws MessagingException {
			eventService.affectereventtoagent(eventid, agentid,"khadija.azzouz@esprit.tn", "BKfIN Team", "Thank you for your participation,you will find your invitation attached ");
